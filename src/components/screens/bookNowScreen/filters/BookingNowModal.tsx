...
export default function BookingModal({
  ...
  return (
    <Modal open={open} onClose={handleClose}>
      <Box sx={modalStyle} className="bg-white p-6 relative shadow-lg">
        ...
        <Image
          ...
          width={500}
          height={300}
          className="h-64 object-contain w-full mb-4"
        />
        ...
        <div className="flex items-center justify-between border-t-2 border-t-[#F58220] pt-1 mt-2 text-[#004d99] font-bold text-sm mb-4">
